...
<div class="varsel-info">
  <div class="row row-cols-4">
    <div class="col"><img src="images/!_edited.png" class="advarsel1" alt="advarsel1" width="80" height="80">
    ...
    <div class="col"><img src="images/1-trekant_edited.png" class="advarsel2" alt="advarsel2" width="80" height="80">
    ...
    <div class="col"><img src="images/2-trekant_edited.png" class="advarsel3" alt="advarsel3" width="80" height="80">
    ...
    <div class="col"><img src="images/3-trekant_edited.png" class="advarsel4" alt="advarsel4" width="80" height="80">
