...
<div class="mainContent-content-wrap" id="weatherMap"> 
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
      <div class="col">
        <div class="card h-70">
          <img src="images/ice.jpg" class="card-img-top" alt="Iskoldt">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card h-70">
          <img src="images/ocean.jpg" class="card-img-top" alt="Koldt">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card h-70">
          <img src="images/winter.jpg" class="card-img-top" alt="Vinter">
          <div class="card-body">
    ...
    <br><br>
      ...
      <div class="col">
        <div class="card h-70">
          <img src="images/pollen.png" class="card-img-top" alt="Forår">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card h-70">
          <img src="images/lake.png" class="card-img-top" alt="Iskold sø">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card h-70">
          <img src="images/sign.png" class="card-img-top" alt="Skilt">
          <div class="card-body">
